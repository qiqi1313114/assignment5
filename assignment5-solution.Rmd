...
ggpairs(D1, 2:8, progress = FALSE) #ggpairs() draws a correlation plot between all the columns you identify by number (second option) and progress = FALSE stops a progress bar appearing as it renders your plot
